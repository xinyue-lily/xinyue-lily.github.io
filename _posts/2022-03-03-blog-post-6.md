...
By embedding visualization our model, We are able to find some interesting relations in the words that the model found useful when distinguishing real news from fake news.

The collection of weights is 10-dimensional. For plotting in 2 dimensions, we select principal component analysis (PCA).
