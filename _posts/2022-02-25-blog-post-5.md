...
(2) The validation accuray of the model3 stabilized **between 59% to 78%** during training, better than model1 and model2.

(3) The highest validation accuracy is **78.09%**. Compare that to the baseline, I improved 26% of accuracy, compared that to the model1, I improved 15% of accuracy, and compared that to the model2, I imporved 8% of accuracy.
