...
(2) After several experiments, the validation accuray of the model2 stabilized between **between 51% to 71%** during training, a little better than model1.

(3) The highest validation accuracy is **70.54%**. Compare that to the baseline, I improved 18% of accuracy.

(4) From the plot, I observed overfitting in model2. For example, in Epoch 13/20, the accuracy accuray is the highest of 70.54%, but from epoch 14 to 20, the training accuray decrease to 67.95%.
...
### My observation
(1) The training speed is improved.

(2) The validation accuray of the model3 stabilized **between 59% to 78%** during training, a little better than model1 and model2.

(3) The highest validation accuracy is **78.09%**. Compare that to the baseline, I improved 26% of accuracy.

(4) From the plot, I observed overfitting in model3. For example, in epoch 19/20, the accuracy accuray is the highest of 78.09%, but in epoch 20, the training accuray dropped to 74.13%.
...
### My observation
(1) The validation accuray of the model4 stabilized **between 77% to 97%** during training, better than model1 and model1,model2 and model3.

(2) The highest validation accuracy is **96.53%**. Compare that to the baseline, I improved 45% of accuracy.
